...
/**
 * Panel que representa una grilla de imagenes, siendo posible agregarle y quitarle imagenes. Asimismo, cuenta con una
...
public class GamePanel extends JPanel {
	 ...
	 * @param cellSize Ancho y alto de cada imagen en pixeles.
	 * @param listener Listener que seri notificado cuando el usuario se posicione sobre una celda de la grilla.
	 * @param color Color de fondo del panel.
	 */
	public GamePanel(final int rows, final int columns, final int cellSize, final GamePanelListener listener, Color color) {
