...
public class MapSelection {
    ...
    private HashMap<String,String> filesMap;
        ...
        public MapSelection(String dirName) throws FileException, FileNotFoundException, IOException{
    ...
    private void readAllNamesMaps() throws FileNotFoundException, IOException, FileException {
        for(int i = 0; i < choices.length; i++) {
            ReadMapName parser = new ReadMapName(Directories.boards + choices[i]);
