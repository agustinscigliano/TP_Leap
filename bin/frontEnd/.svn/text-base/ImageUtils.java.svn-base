...
public class ImageUtils {
	...
	/**
	 * Carga una imagen y retorna una instancia de la misma. Si hay algun problema al leer el archivo lanza una
	 * excepcion.
	 */
	...
	/**
	 * Dibuja un texto en el vertice inferior derecho de la imagen, con el color indicado. Retorna una imagen nueva con
